...
st.title("Specify the topic to generate  MCQ questions with answers..")
...
if st.button("fetch data and generate mcq"):
    ...
    prompt="Create a list of " + str(num) + " mcq questions with 4 answers from the Sepcified topic " + url  + "While specifying the correct answers as well.",
    temperature=0.56,
    max_tokens=2066,
    top_p=1,
